...
const LoginModal = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  return ReactDOM.createPortal(
    // <div className={`login-modal-overlay show`} onClick={(e) => e.target === e.currentTarget && !isLoading && handleClose()}>
    <div
      className={`login-modal-overlay ${isOpen ? 'show' : ''}`}
      onClick={(e) => e.target === e.currentTarget && !isLoading && handleClose()}
    >
      <div className="login-modal" onClick={(e) => e.stopPropagation()}>
        <img src="/images/dialog_wrap.png" alt="" style={{ objectFit: 'fill', position: 'absolute', top: '0' }} />
        <img src="/images/dialog_close_icon.png" alt="" className="close-btn" onClick={handleClose} />
        ...
        <div className="modal-body">
          ...
          <div className="form-group code-group">
            ...
            <input
              ...
              required
            />
            <button className="code-btn" onClick={handleGetCode} disabled={!phone || countdown > 0 || isLoading}>
          ...
          <div style={{ width: '100%', display: 'flex' }}>
            ...
            >
              {isLoading ? (
                <>
                  <span className="loading"></span>登录中...
                </>
              ) : (
                '登录'
              )}
